    ...
    <div key={mapLayer}>
      ...
      <div className="absolute z-50 px-2 py-2 text-black translate-x-[-50%] bg-white rounded-lg bottom-12 left-1/2 w-max h-max drop-shadow">
        ...
        <div className="flex flex-row gap-3 text-sm">
          ...
          <div className="flex flex-row items-center gap-1">
            <div className="w-4 h-4 bg-[#E6160B] rounded" />
            5000/km<span className="text-xs translate-x-[-2.5px] pb-2">2</span>
          </div>
          <div className="flex flex-row items-center gap-1">
            <div className="w-4 h-4 bg-[#CD2711] rounded" />
            10000/km<span className="text-xs translate-x-[-2.5px] pb-2">2</span>
          </div>
          <div className="flex flex-row items-center gap-1">
            <div className="w-4 h-4 bg-[#B43817] rounded" />
            15000/km<span className="text-xs translate-x-[-2.5px] pb-2">2</span>
          </div>
          <div className="flex flex-row items-center gap-1">
            <div className="w-4 h-4 bg-[#9C491D] rounded" />
            20000/km<span className="text-xs translate-x-[-2.5px] pb-2">2</span>
          </div>
          <div className="flex flex-row items-center gap-1">
            <div className="w-4 h-4 bg-[#835A23] rounded" />
            25000/km<span className="text-xs translate-x-[-2.5px] pb-2">2</span>
          </div>
          <div className="flex flex-row items-center gap-1">
            <div className="w-4 h-4 bg-[#6A6B29] rounded" />
            30000/km<span className="text-xs translate-x-[-2.5px] pb-2">2</span>
          </div>
          <div className="flex flex-row items-center gap-1">
            <div className="w-4 h-4 bg-[#517C2F] rounded" />
            35000/km<span className="text-xs translate-x-[-2.5px] pb-2">2</span>
          </div>
          <div className="flex flex-row items-center gap-1">
            <div className="w-4 h-4 bg-[#388D35] rounded" />
            35000/km<span className="text-xs translate-x-[-2.5px] pb-2">2</span>
